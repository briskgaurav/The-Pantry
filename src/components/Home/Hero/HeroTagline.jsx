...
export default function HeroTagline({ hidden }) {
    ...
    return (
        <div ref={rootRef} className="absolute select-none bottom-[2vw] max-md:bottom-[5vw] left-[4vw] right-[4vw] z-200 flex items-end justify-between max-md:gap-[3vw] pointer-events-none" inert={hidden ? true : undefined} aria-hidden={hidden || undefined}>
            {/* Left side: Logo */}
            <Link
                href="#"
                target="_blank"
