...
export default function Barcode({ hidden }) {
    ...
    return (
        <div
            ref={rootRef}
            className="absolute top-[3vw] right-[4vw] z-200 flex max-md:hidden flex-col gap-[.6vw] text-foreground pointer-events-none select-none"
            aria-hidden={hidden || undefined}
        >
            <div className="h-[1.5vw] w-[10vw]">
                <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 112 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            ...
            <div className="flex justify-between items-center text10 font-medium uppercase tracking-[.2em]">
                <div className="relative overflow-hidden h-[1em] w-[7vw]" aria-live="polite">
                    <div 
