...
export default function Barcode({ hidden }) {
    ...
    return (
        <div ref={rootRef} className="absolute top-[3vw] right-[4vw] z-200 flex max-md:hidden flex-col gap-[.6vw] text-foreground pointer-events-none select-none">
            ...
            <div className="flex justify-between items-center text10 font-medium uppercase tracking-[.2em] opacity-80">
